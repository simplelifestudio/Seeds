...
@interface SeedListTableSmallerCell()
{
    
}
@end

@implementation SeedListTableSmallerCell
...
-(void)prepareForReuse
{
    ...
    AsyncImageView* newImageView = [[AsyncImageView alloc] initWithFrame:CGRectMake(x, y, WIDTH_ASYNCIMAGEVIEW_IN_SEEDLISTTABLESMALLERCELL, HEIGHT_ASYNCIMAGEVIEW_IN_SEEDLISTTABLESMALLERCELL)];
