...
#define CELL_ID_FAVORITE_SEEDLISTTABLECELL @"FavoriteSeedListTableCell"
#define CELL_HEIGHT_SEEDLISTTABLECELL 100
#define VIEW_WIDTH_ASYNCIMAGEVIEW_IN_SEEDLISTTABLECELL 100
#define VIEW_HEIGHT_ASYNCIMAGEVIEW_IN_SEEDLISTTABLECELL 100
