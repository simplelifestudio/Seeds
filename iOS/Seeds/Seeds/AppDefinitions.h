...
#define THUMBNAIL_SIZE_SEEDLISTTABLECELL CGSizeMake(200, 120)
#define THUMBNAIL_SIZE_SEEDPICTURECOLLECTIONCELL CGSizeMake(300, 340)
#define THUMBNAIL_SIZE_SEEDPICTUREVIEW CGSizeMake(640, 960)
