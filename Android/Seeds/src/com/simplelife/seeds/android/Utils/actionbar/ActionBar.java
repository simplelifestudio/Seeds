 ...
 *  Seeds
 *
 *  Created by Chris Li on 13-6-29. 
 */

package com.simplelife.seeds.android.utils.actionbar;
...
public class ActionBar extends RelativeLayout implements OnClickListener {
    ...
    public ActionBar(Context context, AttributeSet attrs) {
        ...
        mBarView = (RelativeLayout) mInflater.inflate(R.layout.seeds_actionbar, null);
        addView(mBarView);
    ...
    private View inflateAction(Action action) {
        View view = mInflater.inflate(R.layout.seeds_actionbar_item, mActionsView, false);
