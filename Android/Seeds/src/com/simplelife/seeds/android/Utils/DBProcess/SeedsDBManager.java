 ...
 *  
 * How to use: 
 * 1. Initialize SeedsDBManager 
 * 2. Get SeedsDBManager 
 * 3. Get a SQLiteDatabase object through database file 
 * 4. Use this database object 
 *  
 * Using example: 
 * SeedsDBManager.initManager(getApplication()); // this method is only need call one time 
 * SeedsDBManager mg = SeedsDBManager.getManager();   // get a AssetsDatabaseManager object 
 * SQLiteDatabase db1 = mg.getDatabase("Seeds_App_Database.db");   // get SQLiteDatabase object
 */  
public class SeedsDBManager {  
    ...
    // Singleton Pattern  
    private static SeedsDBManager mInstance = null;  
    ...
    public static void initManager(Context context){  
        if(mInstance == null){  
            mInstance = new SeedsDBManager(context);  
        }  
    }  
      
    /** 
     * Get a SeedsDBManager object 
     * @return, if success return a SeedsDBManager object, else return null 
     */  
    public static SeedsDBManager getManager(){  
        return mInstance;  
    }  
      
    private SeedsDBManager(Context context){  
    ...
    public SQLiteDatabase getDatabase(String dbfile) {  
        ...
        SharedPreferences dbs = context.getSharedPreferences(SeedsDBManager.class.toString(), 0);  
