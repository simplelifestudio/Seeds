package com.simplelife.seeds.android.utils.slidingmenu.lib.app;
...
public class SlidingActivityHelper {
	...
	public void onCreate(Bundle savedInstanceState) {
		mSlidingMenu = (SlidingMenu) LayoutInflater.from(mActivity).inflate(R.layout.seeds_slidingmenu_main, null);
	}
