...
public class SeedsPullToRefreshView extends LinearLayout {
	private static final String TAG = "SeedsPullToRefreshView";
	// refresh states
...
//	private String mLastUpdateTime;
	...
	public SeedsPullToRefreshView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}

	public SeedsPullToRefreshView(Context context) {
		super(context);
		init();
	}
	...
	private void addHeaderView() {
		// header view
		mHeaderView = mInflater.inflate(R.layout.seeds_refresh_header, this, false);
	...
	private void addFooterView() {
		// footer view
		mFooterView = mInflater.inflate(R.layout.seeds_refresh_footer, this, false);
...
//	}
	...
	public interface OnFooterRefreshListener {
		public void onFooterRefresh(SeedsPullToRefreshView view);
	}
